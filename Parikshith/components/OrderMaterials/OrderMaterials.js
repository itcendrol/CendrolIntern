...
function OrderMaterials(props) {
  ...
  function validData() {
    materials.map(materialUom => {
      if (materialUom.uom === '' && categoryEnable === false) {
        alert('Enter quantity for all materials');
        console.log('UOM Invalid');
        return 0;
      }
    });
          ...
          <View style={{flexDirection: 'row'}}>
            <View>
              ...
              <TouchableOpacity
                ...
                <Image style={styles.cal} source={require('./Calendar.png')} />
                <DateTimePickerModal
            ...
            <View>
              ...
              <View
                ...
                <Picker
                  ...
                  <Picker.Item label="High" value="hign" />
                </Picker>
              </View>
            </View>
          </View>
          <View>
            ...
            <View style={[styles.inputBorder, {borderColor: approverValid}]}>
              <Picker
                ...
                onValueChange={(itemValue, itemIndex) => {
                  itemValue !== '0' && setApproverValid('#969696');
