...
const Login = ({navigation}) => {
  ...
  const [emailInputBorder, setEmailInputBorder] = useState('black');
  const [pswdInputBorder, setPswdInputBorder] = useState('black');
      ...
      <ScrollView>
        <View style={styles.screen}>
              ...
              <View style={styles.modalView}>
                ...
                <TouchableOpacity
                  ...
                  <Image
                    ...
                    source={require('./tryAgain.png')}
                  />
                </TouchableOpacity>
              </View>
            </View>
          </Modal>
          <Image style={styles.cendrolImg} source={require('./bgimg.jpg')} />
          <View style={styles.loginCard}>
            ...
            {emailError ? null : (
              <Text style={{color: 'red'}}>Enter valid Email ID</Text>
            )}
            ...
            <View
              ...
              <Text style={pswdLabel}>Password</Text>
              <View
                style={{
                ...
                <Icon
                  ...
                  style={[
                    styles.eye,
                    {height: 50, position: 'absolute', right: 25, bottom: 1},
                  ]}
                  color="grey"
